...
const CategorySidebar: React.FC<CategorySidebarProps> = ({
  ...
  return (
    <div
      className={`${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 fixed md:relative z-30 md:z-auto w-80 sm:w-64 md:w-64 h-full bg-gray-800 border-r border-gray-700 transition-transform duration-300 overflow-y-auto`}
    >
